...
class P2PANFPN(nn.Module):
    """P2-enhanced PAN-FPN for small-object experiments.

    The module keeps the original P3/P4/P5 path and adds one lightweight
    stride-4 P2 output. It is intended only for E3 so E1/E2 can remain
    controlled three-scale comparisons.
    """
